  ...
  render() {
    return (
      <div className="films-list">
        <h1 className="films-list-film-cards films-list-header">🔥 Новинки</h1>
        <div className="films-list-film-cards grid-container">
          <div className="films-list-film-cards-item first">
            <FilmCard
          ...
          <div className="films-list-film-cards-item second">
            <FilmCard
          ...
          <div className="films-list-film-cards-item third">
            <FilmCard
          ...
          <div className="films-list-film-cards-item fourth">
            <FilmCard
        ...
        <h1 className="films-list-genre-cards films-list-header">Жанры</h1>
        <div className="films-list-genre-cards grid-container">
          <div className="films-list-genre-cards-item first">
            <GenreCard
          ...
          <div className="films-list-genre-cards-item second">
            <GenreCard
          ...
          <div className="films-list-genre-cards-item third">
            <GenreCard
          ...
          <div className="films-list-genre-cards-item fourth">
            <GenreCard
